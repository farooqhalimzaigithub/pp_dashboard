                                ...
                                <div class="row ">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                        <div class="card-content">
                                            <h5 class="font-15">New Business Users</h5>
                ...
                <div class="col-md-6 col-lg-12 col-xl-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="support-ticket media pb-1 mb-3">
                                <img src="{{ asset('assets/img/users/user-2.png') }}" class="user-img mr-2"
                                    alt="">
                                <div class="media-body ml-3">
                            ...
                            <div class="support-ticket media pb-1 mb-3">
                                <img src="{{ asset('assets/img/users/user-3.png') }}" class="user-img mr-2"
                                    alt="">
                                <div class="media-body ml-3">
                            ...
                            <div class="support-ticket media pb-1 mb-3">
                                <img src="{{ asset('assets/img/users/user-6.png') }}" class="user-img mr-2"
                                    alt="">
                                <div class="media-body ml-3">
